...
public class Dr_Rash extends AppCompatActivity {
    TextView tv1;
    Button VoiceCall, VideoCall;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dr__rash);
        ...
        VoiceCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent voice_call = new Intent(Dr_Rash.this, Voice_Call.class);
        ...
        VideoCall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent video_call = new Intent(Dr_Rash.this, Video_Call.class);
...
//                Intent intent= new Intent(Dr_Rash.this, Login.class );
...
//        });
//
//        tv1 = (TextView) findViewById(R.id.tv57);
//        tv1.setText( getIntent().getStringExtra("Date"));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_dr__rash__tabbed_, menu);
        return true;
    }
...
//                Intent Tabbed_Screen = new Intent(Dr_Rash.this, Dr_Rash_Tabbed_Activity.class);
