...
public class Dr_Hunter extends AppCompatActivity {
TextView tv;
    Button VoiceCall, VideoCall;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dr__hunter);
        ...
        VoiceCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent voice_call = new Intent(Dr_Hunter.this, Voice_Call.class);
        ...
        VideoCall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent video_call = new Intent(Dr_Hunter.this, Video_Call.class);
...
//                Intent intent= new Intent(Dr_Hunter.this, Login.class );
...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_dr__hunter__tabbed_, menu);
        return true;
    }
...
//                Intent Tabbed_Screen = new Intent(Dr_Hunter.this, Dr_Hunter_Tabbed_Activity.class);
