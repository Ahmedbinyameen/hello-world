...
public class dr_alex extends AppCompatActivity {
TextView tv;
    Button VoiceCall, VideoCall;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dr_alex);
        ...
        VoiceCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent voice_call = new Intent(dr_alex.this, Voice_Call.class);
        ...
        VideoCall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent video_call = new Intent(dr_alex.this, Video_Call.class);
...
//                Intent intent= new Intent(dr_alex.this, Login.class );
...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_dr__alex__tabbed_, menu);
        return true;
    }
...
//                Intent Tabbed_Screen = new Intent(dr_alex.this, Dr_Alex_Tabbed_Activity.class);
