...
public class Tab1_dr_bliss extends Fragment {
    TextView GetDate;
    @Nullable
    private Button book1, book2, book3, book4, book5, book6;
    private View rootView;

//    String GetDatefromActivity;

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
         rootView = inflater.inflate(R.layout.tab_1_dr_bliss, container, false);
//
//        GetDate = (TextView) rootView.findViewById(R.id.date_dr_bliss);
//
//        Bundle b3 = getArguments();
//        String name = b3.getString("date");
//        GetDate.setText(name);


//       String GetDate_fromActivity = this.getArguments().getString("editText" );
//        GetDate.setText(GetDate_fromActivity);
...
//
////        GetDatefromActivity = (TextView) rootView.findViewById(R.id.date_dr_bliss);
//
//        if(getArguments() != null)
//        {
//            GetDatefromActivity = getArguments().getString("editText");
//        }
//    }
