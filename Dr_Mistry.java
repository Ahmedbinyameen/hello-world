...
public class Dr_Mistry extends AppCompatActivity {
TextView tv;
    Button VoiceCall, VideoCall;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dr__mistry);
        ...
        VoiceCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent voice_call = new Intent(Dr_Mistry.this, Voice_Call.class);
        ...
        VideoCall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent video_call = new Intent(Dr_Mistry.this, Video_Call.class);
...
//                Intent intent= new Intent(Dr_Mistry.this, Login.class );
...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_dr__mistry__tabbed_, menu);
        return true;
    }
...
//                Intent Tabbed_Screen = new Intent(Dr_Mistry.this, Dr_Mistry_Tabbed_Activity.class);
