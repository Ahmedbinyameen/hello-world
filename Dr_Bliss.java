...
public class Dr_Bliss extends AppCompatActivity {
    TextView tv;
    Button VoiceCall, VideoCall;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dr__bliss);
        ...
        VoiceCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent voice_call = new Intent(Dr_Bliss.this, Voice_Call.class);
        ...
        VideoCall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent video_call = new Intent(Dr_Bliss.this, Video_Call.class);
...
//                Intent intent= new Intent(Dr_Bliss.this, Login.class );
...
//        tv.setText( getIntent().getStringExtra("Date"));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_dr__bliss__tabbed_, menu);
        return true;
    }
...
//                Intent Tabbed_Screen = new Intent(Dr_Bliss.this, Dr_Bliss_Tabbed_Activity.class);
